...
2. cordova run ios -- --lr (wait till app opens in your ios emulator or phone. it will close console output after publish, so live-reload will not work. go to next step.)
3. cordova run browser -- --lr (you can use live-reload in your phone-emulator and browser at same time. it must work.)
